...
async function upgrade(request,response){
 ...
 if(url.pathname==='/api/health'){
  ...
  return json({...body,version:APP_VERSION,allGameHistoricalIndicators:true,completeGameDetail:true,nonNotableHistoryVisible:true,completeGameDetailAffectsPredictions:false,normalUiRawHistoryReads:false,historicalSummaryOnlyReads:true},response.status,response.headers);
 }
